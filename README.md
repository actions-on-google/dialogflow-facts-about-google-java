...
This is a knowledgeable Action that shares interesting facts about Google. The sample introduces advanced features like custom entities, contexts, and deep links using Java. Use this Action and you might see that it even knows about a subject other than Google!
